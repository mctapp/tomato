...
export const STAGE_COLORS: Record<StageNumber, { bg: string; text: string; border: string }> = {
  ...
  4: { bg: 'bg-green-100', text: 'text-green-800', border: 'border-green-300' },
};
...
export const SPEED_TYPE_INFO: Record<WorkSpeedType, { name: string; label: string; description: string; color: string }> = {
  A: {
    name: '빠름',
    label: '빠름',
